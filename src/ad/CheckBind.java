...
public class CheckBind
{
	...
	public static final int ActiveDirectory = 0;
	public static String  locale = date.toString();

	public static void main( String[] args )
	{		
		int    ldapVersion = LDAPConnection.LDAP_V3;
		String ldapHost    = "192.168.10.244";
		int    ldapPort    = 389;
		String loginDN     = "cn=holy,cn=users,dc=workspace,dc=apht,dc=net";
		String password    = "holy";
		String userDN      = "cn=holy,cn=users,dc=workspace,dc=apht,dc=net";
		String userPWD     = "holy";
		...
		if ( GetBindInfo( lc, userDN, userPWD, ActiveDirectory) )
	...
	public static boolean GetBindInfo( LDAPConnection lc,
									   String userDN, String userPWD,int LDAPtype)
	{
		int     i;
